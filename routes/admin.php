...
//customers
    Route::group(['prefix' => 'admin/customers', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
     ...
     Route::group(['prefix' => 'admin/vendors', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        Route::get('/address/display/{id}/', 'VendorsController@diplayaddress')->middleware('add_customer');
        Route::post('/addcustomeraddress', 'VendorsController@addcustomeraddress')->middleware('add_customer');
        Route::post('/editaddress', 'VendorsController@editaddress')->middleware('edit_customer');
        Route::post('/updateaddress', 'VendorsController@updateaddress')->middleware('edit_customer');
        Route::post('/deleteAddress', 'VendorsController@deleteAddress')->middleware('edit_customer');
    });
