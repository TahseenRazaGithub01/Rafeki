...
// Route::get('/vendorLogin', 'CustomersController@vendorLogin');
Route::get('/vendor-login', 'CustomersController@vendorLogin');
...
Route::group(['namespace' => 'Web','middleware' => $middleware], function () {
	...
	// route for to show payment form using get method
		...
		Route::get('/supplier-product/vendor/{slug}', 'ProductsController@supplierProduct');
		
		Route::get('/store/{slug}', 'ProductsController@supplierProduct')->name('store');
		Route::get('/product-detail1/{slug}', 'ProductsController@productDetail1');
		...
		Route::get('/{category_slug}', 'ProductsController@category');
	});
