...
<script src="{!! asset('rafekiweb/assets/js/jquery.instagramFeed.min.js')  !!}"></script>
...
<script src="{!! asset('rafekiweb/assets/js/stripe_card.js') !!}" data-rel-js></script>
...
@endif
<script src="{!! asset('rafekiweb/assets//js/scripts.js') !!}"></script>
<script>
/////////////////// default code ///////////////////
