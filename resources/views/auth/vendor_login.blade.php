	...
	<nav aria-label="breadcrumb">
		<div class="container">
			<ol class="breadcrumb">
			  ...
			  <li class="breadcrumb-item active" aria-current="page">@lang('website.Vendor Login')</li>
	...
	<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-6">
						<div class="col-12"><h4 class="heading login-heading">@lang('website.NEW VENDOR')</h4></div>
						<div class="registration-process">
							...
							<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
								<input type="hidden" name="vendor_login" value="vendor_login">
								{{csrf_field()}}
								...
								<!-- Start Add Store Name -->
								<div class="from-group mb-3">
									<div class="col-12"> <label for="inlineFormInputGroup"><strong style="color: red;">*</strong>@lang('website.storeName')</label></div>
									<div class="input-group col-12">										
										<input  name="store_name" type="text" class="form-control field-validate" id="store_name" placeholder="@lang('website.pleaseEnterYourStorename')" value="{{ old('store_name') }}">
										<span class="form-text text-muted error-content" hidden>@lang('website.pleaseEnterYourStorename')</span>
									</div>
								</div>
								<!-- End Add Store Name -->
