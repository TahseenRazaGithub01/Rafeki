<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php
        if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->vendors_view == 1){
      ?>
        <li class="treeview {{ Request::is('admin/vendors/display') ? 'active' : '' }}  {{ Request::is('admin/vendors/add') ? 'active' : '' }}  {{ Request::is('admin/vendors/edit/*') ? 'active' : '' }} {{ Request::is('admin/vendors/address/display/*') ? 'active' : '' }} {{ Request::is('admin/vendors/filter') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/vendors/display')}}">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_vendors') }}</span>
          </a>
        </li>
      <?php } ?>
