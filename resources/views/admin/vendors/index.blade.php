...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.Vendors') }} <small>{{ trans('labels.ListingAllVendors') }}...</small> </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6 form-inline" id="contact-form">
                                    <form name='registration' id="registration" class="registration" method="get" action="{{url('admin/vendors/filter')}}">
                                        ...
                                        <div class="input-group-form search-panel ">
                                            ...
                                            @if(isset($parameter,$filter)) <a class="btn btn-danger " href="{{url('admin/vendors/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                        </div>
                                    </form>
                                                ...
                                                <ul class="nav table-nav">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/vendors/edit') }}/{{$listingCustomers->id}}">{{ trans('labels.EditVendors') }}</a></li>
                                                            <li role="presentation" class="divider"></li>
                                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="{{url('admin/vendors/address/display/'.$listingCustomers->id) }}">{{ trans('labels.EditAddress') }}</a></li>
                                                            <li role="presentation" class="divider"></li>
