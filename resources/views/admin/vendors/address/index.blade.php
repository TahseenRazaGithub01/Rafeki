                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">{{ trans('labels.ListingVendorAddresses') }}</h3>
                        ...
                        <div class="box-body">
                                        ...
                                        @if (count($data['customer_addresses']) > 0)
                                            @foreach($data['customer_addresses'] as $customer_addresses)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge bg-light-blue editAddressModalV" user_id = '{{ $data['user_id'] }}' address_book_id = "{{ $customer_addresses->address_book_id }}" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ URL::to('admin/vendors/display')}}" class="btn btn-primary">{{ trans('labels.SaveComplete') }}</a>
                            </div>
                            <!-- /.box-body -->
                        </div>
                        ...
                        <!-- vendorEditAddressModal -->
                        <div class="modal fade" id="editAddressModalV" tabindex="-1" role="dialog" aria-labelledby="editAddressModalLabel">
                            <div class="modal-dialog" role="document">
                        ...
                        <div class="modal fade" id="deleteAddressModal" tabindex="-1" role="dialog" aria-labelledby="deleteAddressModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    {!! Form::open(array('url' =>'admin/vendors/deleteAddress', 'name'=>'deleteAddress', 'id'=>'deleteAddress', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
