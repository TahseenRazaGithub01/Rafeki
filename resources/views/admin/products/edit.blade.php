                                            ...
                                            @if(Auth::user()->id == 1)
                                             <div class="col-xs-12 col-md-12">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Vendor<span style="color:red;">*</span></label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control " name="user_id">
                                                            <option value="1">Rafeki</option>
                                                            @foreach($result['vendors'] as $vendor)
                                                            <option value="{{$vendor->id}}"  @if($result['product'][0]->user_id==$vendor->id) selected @endif >{{$vendor->first_name}} {{$vendor->last_name}}</option>
                                                            @endforeach
                                                        </select>
